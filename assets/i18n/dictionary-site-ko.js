    ...
    site: {
      ...
      privacy: {
        ...
        browser: {
          ...
          title: "브라우저에 남는 것",
          lead: "아래 항목은 이 브라우저의 저장소에만 있습니다. 서버로 보내지 않고, 다른 기기에서는 보이지 않습니다.",
        ...
        retention: {
          eyebrow: "HOW LONG",
          title: "공개 링크의 보관 기간",
          lead: "공개 링크는 열릴 때마다 수명이 밀리는 방식으로 만료됩니다.",
          one: "발행하면 7일 뒤에 만료되도록 표시됩니다.",
          two: "누군가 링크를 열 때마다 만료 시점이 그때로부터 다시 7일 뒤로 밀립니다.",
      ...
      terms: {
        ...
        expiry: {
          ...
          one: "마지막으로 열린 뒤 7일이 지나면 만료됩니다. 누가 열 때마다 이 기간은 다시 밀립니다.",
