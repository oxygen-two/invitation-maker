  ...
  return {
    site: {
      ...
      guide: {
        ...
        toc: { steps: "세 단계", finish: "완성 방식 세 가지", assistant: "AI 어시스턴트로 만들기", data: "내 데이터는 어디에", faq: "자주 묻는 질문" },
        steps: {
      ...
      privacy: {
        ...
        server: {
          ...
          seven: "AI 어시스턴트(MCP)로 만들 때 입력한 문장. 초안을 만들기 위해 Anthropic API로 전송되며, 이 서비스의 서버에는 저장되지 않아요.",
