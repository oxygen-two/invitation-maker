    ...
    site: {
      ...
      privacy: {
        ...
        retention: {
          ...
          three: "아무리 자주 열려도 발행일로부터 30일을 넘기지 않습니다. 다만 초대장에 일시를 적었다면 그날로부터 7일 뒤까지는 열립니다. 초대장은 행사 전에 보내는 것이라, 행사 당일 전에 링크가 닫히지 않도록 한 것입니다. 발행일로부터 400일보다 먼 일시는 이 연장에 쓰이지 않습니다.",
          note: "7일, 30일, 행사 후 7일은 현재 운영 기본값이며 운영자가 바꿀 수 있습니다. 만료된 링크는 더 이상 열리지 않습니다."
        },
        analytics: {
          eyebrow: "04",
          title: "방문 통계",
      ...
      terms: {
        ...
        expiry: {
          ...
          two: "아무리 자주 열려도 발행일로부터 30일이 지나면 만료됩니다. 초대장에 일시를 적은 경우에는 그날로부터 7일 뒤까지 열립니다.",
          three: "7일, 30일, 행사 후 7일은 현재 운영 기본값이며 운영자가 바꿀 수 있습니다. 만료되거나 취소된 링크는 되살릴 수 없고, 초대장을 다시 열어 새 링크를 발행해야 합니다."
        },
        contact: {
          eyebrow: "07",
          title: "문의와 약관 변경",
