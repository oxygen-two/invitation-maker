(function (root) {
  ...
  const standaloneCss = `
    ...
    :root{--bg:#ead5ce;--paper:#fffaf2;--ink:#2a1720;--soft:#65535a;--deep:#42101f;--mid:#7a243b;--gold:#d9ac54;--line:rgba(101,58,65,.16);--white:#fffdf9;--ink-soft:#65535a;--wine-950:#2d0b16;--wine-900:#42101f;--wine-700:#7a243b;--wine-600:#9b3d54;--cream-50:#fffaf2;--cream-100:#fbf1df;--gold-500:#d9ac54;--gold-300:#f6dda6;--rose-100:#f5d9d5;--hero-end:#a04d55;--particle-light:#fff0ba;--particle-accent:#c84f70;--particle-alt:#4f8778;--particle-edge:rgba(66,16,31,.5);--particle-glow:rgba(255,232,157,.72)}
