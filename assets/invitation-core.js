(function (root) {
  ...
  const standaloneCss = `
    ...
    :root{--bg:#ead5ce;--paper:#fffaf2;--ink:#2a1720;--soft:#65535a;--deep:#42101f;--mid:#7a243b;--gold:#d9ac54;--line:rgba(101,58,65,.16);--particle-light:#fff0ba;--particle-accent:#c84f70;--particle-alt:#4f8778;--particle-edge:rgba(66,16,31,.5);--particle-glow:rgba(255,232,157,.72)}
    body[data-template="wedding"]{--bg:#f2e8d8;--paper:#fffaf1;--ink:#33241a;--soft:#705d4c;--deep:#6d4f31;--mid:#9b7551;--gold:#c7a15d;--particle-light:#ffe6a8;--particle-accent:#9a5e36;--particle-alt:#6f8570;--particle-edge:rgba(58,42,29,.5);--particle-glow:rgba(255,225,151,.72)}
    body[data-template="black-tie"]{--bg:#d8d3ca;--paper:#f8f4ec;--ink:#17191f;--soft:#5f6876;--deep:#08090b;--mid:#353b48;--gold:#c9a45e;--particle-light:#f4d47f;--particle-accent:#b55063;--particle-alt:#70a99a;--particle-edge:rgba(8,9,11,.72);--particle-glow:rgba(244,212,127,.68)}
    body[data-template="botanical"]{--bg:#e4ead8;--paper:#fbfbef;--ink:#102018;--soft:#52695b;--deep:#1f3a2c;--mid:#407055;--gold:#b89d50;--particle-light:#f0cf77;--particle-accent:#567c4b;--particle-alt:#ba6674;--particle-edge:rgba(16,32,24,.58);--particle-glow:rgba(240,207,119,.65)}
    body[data-template="modern"]{--bg:#efe9e3;--paper:#fffaf5;--ink:#1f1b1a;--soft:#6d625b;--deep:#34302d;--mid:#766b62;--gold:#b17846;--particle-light:#f3c47f;--particle-accent:#8f4e52;--particle-alt:#4e7a73;--particle-edge:rgba(31,27,26,.56);--particle-glow:rgba(243,196,127,.66)}
